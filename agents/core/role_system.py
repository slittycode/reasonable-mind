    ...
    def _register_default_roles(self) -> None:
        ...
        self.register(
            RolePersona(
                ...
                forbidden_phrases=["obviously", "simply", "just", "as everyone knows"],
                required_disclaimers=[],
            )
        )
        ...
        self.register(
            RolePersona(
                ...
                reasoning_mode=ReasoningMode(
                    ...
                    forbidden_fallacies=["begging_the_question", "false_dichotomy"],
                    preferred_argument_forms=[
                ...
                vocabulary={},
                forbidden_phrases=["the answer is", "you should", "obviously"],
                required_disclaimers=[],
            )
        )
        ...
        self.register(
            RolePersona(
                ...
                vocabulary={},
                forbidden_phrases=["I believe", "in my view", "personally"],
                required_disclaimers=[],
            )
        )
...
class RoleAdapter:
    ...
    def adapt_response(
        self, response: str, role_id: Optional[str] = None
    ) -> AdaptedResponse:
    ...
    def validate_reasoning(
        self, reasoning_steps: List[str], role_id: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def get_role_context(self, role_id: Optional[str] = None) -> Dict[str, Any]:
...
class PersonaManager:
    ...
    def clone_with_modifications(
        self, source_role_id: str, new_role_id: str, modifications: Dict[str, Any]
        ...
        new_persona = RolePersona(
            ...
            expertise_level=modifications.get(
                "expertise_level", source.expertise_level
            ),
            communication_style=modifications.get(
            ...
            forbidden_phrases=modifications.get(
                "forbidden_phrases", source.forbidden_phrases.copy()
            ),
            required_disclaimers=modifications.get(
                "required_disclaimers", source.required_disclaimers.copy()
            ),
        )
